...
<%
	  ...
	  bMgr.upCount(board, num);//조회수 증가
	  BoardBean bBean = bMgr.getBoard(board, num);//게시물 가져오기
...
<table align="center" width="70%" border=0 cellspacing="3" cellpadding="0">
 ...
 <a href="update.jsp?nowPage=<%=nowPage%>&num=<%=num%>&board=<%=board%>" >수 정</a> |
 <a href="reply.jsp?nowPage=<%=nowPage%>&board=<%=board%>" >답 변</a> |
 <a href="delete.jsp?nowPage=<%=nowPage%>&num=<%=num%>&board=<%=board%>">삭 제</a> ]<br>
  </td>
 </tr>
</table>
