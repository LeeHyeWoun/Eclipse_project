...
public class BoardMgr {
	...
	// 게시판 리스트
	public Vector<BoardBean> getBoardList(String board, String keyField, String keyWord,
			int start, int end) {
		Connection con = null;
	...
	//총 게시물수
	public int getTotalCount(String board, String keyField, String keyWord) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	// 게시물 입력
	public void insertBoard(String board, HttpServletRequest req) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	// 게시물 리턴
	public BoardBean getBoard(String board, int num) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	// 조회수 증가
	public void upCount(String board, int num) {
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		try {
	...
	// 게시물 삭제
	public void deleteBoard(String board, int num) {
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		ResultSet rs = null;
	...
	// 게시물 수정
	public void updateBoard(String board, BoardBean bean) {
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		try {
	...
	// 게시물 답변
	public void replyBoard(String board, BoardBean bean) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	// 답변에 위치값 증가
	public void replyUpBoard(String board, int ref, int pos) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	public void post1000(String board){
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		try {
	...
	//main
	public static void main(String board, String[] args) {
		new BoardMgr().post1000(board);
