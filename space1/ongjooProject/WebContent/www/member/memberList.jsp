...
<script type="text/javascript">
	function list() {
		document.listFrm.action = "memberList.jsp";
...
<body bgcolor="#f9f1e5" onLoad="regFrm.id.focus()">
	...
	<table align="center" border="0" width="90%">
		<tr>
			<td align="center"><font color="#996600"><b><h2>회원 목록</h2></b></font></td>
		</tr>
		<tr>
	...
	<table align="center" border="0" width="90%" cellspacing="0" cellpadding="3">
			...
			<td align="center" colspan="2">
				...
				<table border="1" width="1200" cellspacing="0" cellpadding="2" align="center">
					...
					<tr>
						...
						<td width="6%">
							<a href="memberListUpdate.jsp?id=<%=mId%>"><font color="blue"><%=mId%></font></a>
						</td>
						<td width="6%"><%=mPw%></td>
						<td width="6%"><%=mName%></td>
		...
		<tr>
			...
			<td align="right">
				<a href="memberListDelete.jsp">[삭제]</a>
			</td>
		</tr>
	</table>
	</div>
