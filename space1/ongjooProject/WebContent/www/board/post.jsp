...
<table width="80%" cellspacing="0" cellpadding="3">
	<tr>
		<td bgcolor="28696A" height="25" align="center"><h3><font color=white>글쓰기</font></h3></td>
	</tr>
</table>
<br>
<form name="postFrm" method="post" action="postProc.jsp?board=<%=board%>" enctype="multipart/form-data">
