...
<%@page import="www.BoardBean, java.util.*" %>

<jsp:useBean id="bMgr" class="www.BoardMgr" />
<%	
	  String board = "tblBoard2"; //게시판의 이름
	...
	totalRecord = bMgr.getTotalCount(board, keyField, keyWord);
...
<script type="text/javascript">
	...
	function read(board,num){
		document.readFrm.num.value=num;
		document.readFrm.board.value=board;
...
<div align="center">
	...
	<table align="center" width="80%" border="0" cellspacing="0" cellpadding="3">
		<tr>
			...
			<%
				  vlist = bMgr.getBoardList(board,keyField, keyWord, start, end);
			...
			%>
				  <table border="0" width="100%" cellpadding="2" cellspacing="0">
					...
					<tr>
						...
						%>
						  <a href="javascript:read('<%=board%>','<%=num%>')"><%=subject%></a>
						</td>
		...
		<tr>
			...
			<%
				...
				<td align="right">
					<a href="post.jsp?board=<%=board%>">[글쓰기]</a> 
